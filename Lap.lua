-- ZilpX Menu - ESP, Hitbox, Aim, FOV, Tracer, Menu chức năng mặc định, Drag menu chức năng
local TEAM_COLORS = {
...
--------------------------
-- UI (Circle menu + bảng menu chức năng)
--------------------------
local menuCircleBtn
local menuFrame
...
local function createUI()
    ...
    menuFrame.Position = UDim2.new(0.5, -110, 0.5, -265) -- Mặc định giữa màn hình
